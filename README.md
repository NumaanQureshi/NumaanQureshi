...
* **[Journey](https://github.com/NumaanQureshi/Journey)** - An AI-assisted fitness tracking app featuring workout planning, analytics, and GPT-powered form-correction feedback. *Built with Flutter, Python (Flask), and PostgreSQL (Supabase).*

---

### 📚 Core Coursework
*Cyber Risk • Software Analysis and Design • Data Structures • Operating Systems • Computer Architecture • Database Management*
